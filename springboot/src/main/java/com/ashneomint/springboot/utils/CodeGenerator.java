...
public class CodeGenerator {
    private static final String DATASOURCE = "dormitory-sys";
    private static final String basePath = "D:\\毕设\\作品\\2022.4\\高校迎新\\springboot\\";

    private static final String tableName = "codes";
    private static final String modelName = "公告管理";
    ...
    private static void generate(String tableName) {
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .packageConfig(builder -> {
                    builder.parent("com.ashneomint.springboot") // 设置父包名
